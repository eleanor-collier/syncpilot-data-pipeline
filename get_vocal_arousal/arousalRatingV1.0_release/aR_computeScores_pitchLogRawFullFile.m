% aR_computeScores_pitchLogRawFullFile.m - build neutral emotion models (or global
...
function aR_computeScores_pitchLogRawFullFile(main,wav_dir,feat_dir,score_dir)
